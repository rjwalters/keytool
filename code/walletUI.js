...
class WalletUI {
  ...
  attachEventListeners() {
    ...
    this.toggleEntropyBtn.addEventListener("click", () =>
      this.toggleDisplayMode("entropy"),
    );
    this.toggleMnemonicBtn.addEventListener("click", () =>
      this.toggleDisplayMode("mnemonic"),
    );
    this.toggleAddressesBtn.addEventListener("click", () =>
  ...
  toggleAddressList() {
    ...
    this.addressList.style.display = this.isAddressListVisible
      ? "block"
      : "none";
  ...
  updateDisplay() {
    if (this.wallet) {
      this.walletDataTextarea.value =
        this.currentDisplayMode === "entropy"
          ? this.wallet.entropy || ""
